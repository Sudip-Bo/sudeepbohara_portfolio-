    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-8">
          ...
          <a href="/admin/services" className="text-accent-indigo hover:text-accent-cyan transition-colors">
            ← Back to Services
          </a>
        </div>

        <form action="/api/services" method="POST" className="bg-surface-1 border border-border-subdued rounded-xl p-8 space-y-6">
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={8}
              className="w-full px-4 py-3 rounded-xl border border-border-subdued bg-surface-2 text-foreground focus:border-accent-indigo focus:ring-2 focus:ring-accent-indigo/20 outline-none transition-all resize-none"
              placeholder="Detailed service content (supports HTML)"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              name="icon"
              className="w-full px-4 py-3 rounded-xl border border-border-subdued bg-surface-2 text-foreground focus:border-accent-indigo focus:ring-2 focus:ring-accent-indigo/20 outline-none transition-all"
              placeholder="e.g., Layout, Code, Smartphone"
            />
          </div>
          ...
          <div>
            ...
            />
            <p className="text-sm text-muted-foreground mt-1">e.g., Responsive design, SEO optimization, Performance tuning</p>
          </div>
